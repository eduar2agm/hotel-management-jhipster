...
import { Pencil, Plus, ChevronLeft, User, ChevronRight, Eye, Check, CheckCircle2, XCircle, Trash2, RefreshCcw, AlertCircle, CreditCard, Calendar, Search, ChevronsUpDown } from 'lucide-react';
    ...
    const onSubmit = async (data: ReservaFormValues) => {
        try {
            ...
            if (isEditing && data.id) {
                ...
                // --- MANUALLY TRIGGER PAYMENT FLOW FOR NEW RESERVATION ---
                setIsDialogOpen(false);
                loadData(); // Load data in background
                
                // Enrich reserva with full client data (as backend response might be partial)
