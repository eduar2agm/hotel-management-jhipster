...
public class RedSocialResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new redSocialDTO, or with status {@code 400 (Bad Request)} if the redSocial has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("")
    public ResponseEntity<RedSocialDTO> createRedSocial(@Valid @RequestBody RedSocialDTO redSocialDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/red-socials/" + redSocialDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, redSocialDTO.getId().toString()))
            .body(redSocialDTO);
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated redSocialDTO,
     * or with status {@code 400 (Bad Request)} if the redSocialDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the redSocialDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/{id}")
    public ResponseEntity<RedSocialDTO> updateRedSocial(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, redSocialDTO.getId().toString()))
            .body(redSocialDTO);
    }

    /**
     * {@code PATCH  /red-socials/:id} : Partial updates given fields of an existing redSocial, field will ignore if it is null
     *
     * @param id the id of the redSocialDTO to save.
     * @param redSocialDTO the redSocialDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated redSocialDTO,
     * or with status {@code 400 (Bad Request)} if the redSocialDTO is not valid,
     * or with status {@code 404 (Not Found)} if the redSocialDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the redSocialDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<RedSocialDTO> partialUpdateRedSocial(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody RedSocialDTO redSocialDTO
    ) throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, redSocialDTO.getId().toString())
        );
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of redSocials in body.
     */
    @GetMapping("")
    public ResponseEntity<List<RedSocialDTO>> getAllRedSocials(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the redSocialDTO, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/{id}")
