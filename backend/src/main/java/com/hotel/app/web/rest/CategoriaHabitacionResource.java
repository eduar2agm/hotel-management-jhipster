...
public class CategoriaHabitacionResource {
     ...
     *         body the new categoriaHabitacionDTO, or with status
     *         {@code 400 (Bad Request)} if the categoriaHabitacion has already an
     *         ID.
    ...
    public ResponseEntity<CategoriaHabitacionDTO> createCategoriaHabitacion(
            @Valid @RequestBody CategoriaHabitacionDTO categoriaHabitacionDTO) throws URISyntaxException {
        LOG.debug("REST request to save CategoriaHabitacion : {}", categoriaHabitacionDTO);
        if (categoriaHabitacionDTO.getId() != null) {
            throw new BadRequestAlertException("A new categoriaHabitacion cannot already have an ID", ENTITY_NAME,
                    "idexists");
        }
        ...
        return ResponseEntity.created(new URI("/api/categoria-habitacions/" + categoriaHabitacionDTO.getId()))
                .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME,
                        categoriaHabitacionDTO.getId().toString()))
                .body(categoriaHabitacionDTO);
    }

    /**
     * {@code PUT  /categoria-habitacions/:id} : Updates an existing
     * categoriaHabitacion.
     *
     ...
     *         the updated categoriaHabitacionDTO,
     *         or with status {@code 400 (Bad Request)} if the
     *         categoriaHabitacionDTO is not valid,
     *         or with status {@code 500 (Internal Server Error)} if the
     *         categoriaHabitacionDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    /**
     * {@code PATCH  /categoria-habitacions/:id} : Partial updates given fields of
     * an existing categoriaHabitacion, field will ignore if it is null
     *
     * @param id                     the id of the categoriaHabitacionDTO to save.
     * @param categoriaHabitacionDTO the categoriaHabitacionDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     ...
     *         or with status {@code 400 (Bad Request)} if the
     *         categoriaHabitacionDTO is not valid,
     *         or with status {@code 404 (Not Found)} if the categoriaHabitacionDTO
     *         is not found,
     *         or with status {@code 500 (Internal Server Error)} if the
     *         categoriaHabitacionDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
    ...
    public ResponseEntity<CategoriaHabitacionDTO> partialUpdateCategoriaHabitacion(
            @PathVariable(value = "id", required = false) final Long id,
            @NotNull @RequestBody CategoriaHabitacionDTO categoriaHabitacionDTO) throws URISyntaxException {
    ...
    public ResponseEntity<List<CategoriaHabitacionDTO>> getAllCategoriaHabitacions(
        ...
        Page<CategoriaHabitacionDTO> page;
        if (activo != null) {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the categoriaHabitacionDTO, or with status {@code 404 (Not Found)}.
     */
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN', 'ROLE_EMPLOYEE', 'ROLE_CLIENT')")
    @GetMapping("/{id}")
    ...
    /**
     * {@code DELETE  /categoria-habitacions/:id} : delete the "id"
     * categoriaHabitacion.
     *
    ...
    /**
     * {@code PUT  /categoria-habitacions/:id/activate} : activate the "id"
     * categoriaHabitacion.
     *
     * @param id the id of the categoriaHabitacionDTO to activate.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)}.
     */
    @PutMapping("/{id}/activate")
    @PreAuthorize("hasAuthority('ROLE_ADMIN')")
    public ResponseEntity<Void> activateCategoriaHabitacion(@PathVariable Long id) {
        LOG.debug("REST request to activate CategoriaHabitacion : {}", id);
        categoriaHabitacionService.activate(id);
        return ResponseEntity.ok().build();
    }

    /**
     * {@code PUT  /categoria-habitacions/:id/deactivate} : deactivate the "id"
     * categoriaHabitacion.
     *
     * @param id the id of the categoriaHabitacionDTO to deactivate.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)}.
     */
    @PutMapping("/{id}/deactivate")
    @PreAuthorize("hasAuthority('ROLE_ADMIN')")
    public ResponseEntity<Void> deactivateCategoriaHabitacion(@PathVariable Long id) {
        LOG.debug("REST request to deactivate CategoriaHabitacion : {}", id);
        categoriaHabitacionService.deactivate(id);
        return ResponseEntity.ok().build();
    }
}
