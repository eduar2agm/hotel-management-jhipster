...
/**
 * REST controller for managing {@link com.hotel.app.domain.ConfiguracionSistema}.
 */
@RestController
...
public class ConfiguracionSistemaResource {
    ...
    public ResponseEntity<ConfiguracionSistemaDTO> createConfiguracionSistema(
        ...
        return ResponseEntity.created(new URI("/api/configuracion-sistemas/" + configuracionSistemaDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, configuracionSistemaDTO.getId().toString()))
    ...
    public ResponseEntity<ConfiguracionSistemaDTO> updateConfiguracionSistema(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, configuracionSistemaDTO.getId().toString()))
            .body(configuracionSistemaDTO);
    }
    ...
    public ResponseEntity<ConfiguracionSistemaDTO> partialUpdateConfiguracionSistema(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, configuracionSistemaDTO.getId().toString())
        );
    }
